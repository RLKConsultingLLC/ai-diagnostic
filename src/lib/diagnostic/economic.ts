...
const INDUSTRY_PRODUCTIVITY_POTENTIAL: Record<Industry, { low: number; high: number; avgLaborCostPercent: number }> = {
  ...
  consumer_retail: { low: 0.15, high: 0.30, avgLaborCostPercent: 0.50 },
  federal_government: { low: 0.12, high: 0.22, avgLaborCostPercent: 0.70 },
  state_local_government: { low: 0.12, high: 0.22, avgLaborCostPercent: 0.72 },
  nonprofit: { low: 0.10, high: 0.20, avgLaborCostPercent: 0.65 },
  ...
  hospitality_travel: { low: 0.16, high: 0.30, avgLaborCostPercent: 0.55 },
  real_estate: { low: 0.14, high: 0.25, avgLaborCostPercent: 0.50 },
...
const AVG_COST_PER_EMPLOYEE: Record<Industry, number> = {
  ...
  consumer_retail: 55000,
  federal_government: 105000,
  state_local_government: 85000,
  nonprofit: 65000,
  aerospace_defense: 120000,
  telecommunications: 110000,
  hospitality_travel: 50000,
  real_estate: 80000,
  education: 75000,
