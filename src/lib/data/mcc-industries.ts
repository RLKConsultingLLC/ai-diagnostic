...
export const MCC_INDUSTRY_TREE: MCCCategory[] = [
  {
    ...
    subcategories: [
      ...
      { label: 'Investment Banking & M&A Advisory', diagnosticSlug: 'investment_banking' },
      ...
      { label: 'Private Equity & Buyout Firms', diagnosticSlug: 'private_equity' },
      { label: 'Venture Capital & Growth Equity', diagnosticSlug: 'venture_capital' },
      { label: 'Hedge Funds & Alternative Investments', diagnosticSlug: 'hedge_funds' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { label: 'Strategy & Operations Consulting', diagnosticSlug: 'consulting_services' },
  ...
  },
  {
    ...
    defaultSlug: 'accounting_audit',
    subcategories: [
      { label: 'Public Accounting & Audit Firms', diagnosticSlug: 'accounting_audit' },
      { label: 'Big Four Professional Services', diagnosticSlug: 'accounting_audit' },
      { label: 'Tax Preparation & Advisory', diagnosticSlug: 'accounting_audit' },
      { label: 'Bookkeeping & Outsourced Finance', diagnosticSlug: 'accounting_audit' },
      { label: 'Forensic Accounting', diagnosticSlug: 'accounting_audit' },
      { label: 'Payroll Services', diagnosticSlug: 'accounting_audit' },
    ],
  },
  {
    name: 'Legal Services',
    defaultSlug: 'legal_services',
    subcategories: [
      { label: 'Law Firms (Corporate / Commercial)', diagnosticSlug: 'legal_services' },
      { label: 'Law Firms (Litigation)', diagnosticSlug: 'legal_services' },
      { label: 'Law Firms (General Practice)', diagnosticSlug: 'legal_services' },
      { label: 'Intellectual Property & Patent Law', diagnosticSlug: 'legal_services' },
      { label: 'Tax Law', diagnosticSlug: 'legal_services' },
      { label: 'Legal Technology & E-Discovery', diagnosticSlug: 'legal_services' },
      { label: 'Alternative Legal Service Providers', diagnosticSlug: 'legal_services' },
    ],
  },
  {
  ...
  },
  {
    ...
    subcategories: [
      ...
      { label: 'Hospitals & Health Systems', diagnosticSlug: 'healthcare_providers' },
      ...
      { label: 'Health Insurance & Payers', diagnosticSlug: 'healthcare_payers' },
      { label: 'Managed Care Organizations', diagnosticSlug: 'healthcare_payers' },
      { label: 'Pharmacy Benefit Managers (PBM)', diagnosticSlug: 'healthcare_payers' },
    ],
  },
  {
    name: 'Pharmaceuticals & Life Sciences',
    defaultSlug: 'life_sciences_pharma',
    subcategories: [
      { label: 'Pharmaceutical Manufacturing', diagnosticSlug: 'life_sciences_pharma' },
      { label: 'Biotechnology', diagnosticSlug: 'life_sciences_pharma' },
      { label: 'Medical Devices & Equipment', diagnosticSlug: 'life_sciences_pharma' },
      { label: 'Clinical Research & CROs', diagnosticSlug: 'life_sciences_pharma' },
      { label: 'Generic & Specialty Drugs', diagnosticSlug: 'life_sciences_pharma' },
      { label: 'Genomics & Precision Medicine', diagnosticSlug: 'life_sciences_pharma' },
      { label: 'Pharmaceutical Distribution', diagnosticSlug: 'life_sciences_pharma' },
    ],
  },
  {
    name: 'Education',
  ...
  },
  {
    ...
    subcategories: [
      ...
      { label: 'Courts & Legal Administration', diagnosticSlug: 'government_state_local' },
